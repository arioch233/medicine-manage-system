package com.moumouzhandui.mms.strategy.impl;

import com.moumouzhandui.mms.exception.ServiceException;
import com.moumouzhandui.mms.strategy.UploadStrategy;
...
public abstract class AbstractUploadStrategyImpl implements UploadStrategy {
    ...
    public String uploadFile(MultipartFile file, String path) {
        try {
            // 获取文件md5值
            String md5 = MyFileUtils.getMd5(file.getInputStream());
            // 获取文件扩展名
            String extName = MyFileUtils.getExtName(file.getOriginalFilename());
            // 重新生成文件名
