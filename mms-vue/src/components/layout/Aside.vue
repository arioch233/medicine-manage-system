...
<!--      <h3 style="text-align: center; color: white; height: 50px; line-height: 50px;">-->
<!--        <el-image style="width: 50px; height: 50px;position: relative; margin-right: 5px " :src="url"-->
<!--                  fit="fill"></el-image>-->
<!--        <span style="" v-show="!this.$store.state.collapse">某某医药</span>-->
<!--      </h3>-->
