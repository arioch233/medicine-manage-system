...
export default {
  ...
  methods: {
    ...
    changeResource(resource) {
      this.request.post("/resource/update", resource).then(data => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
    ...
    deleteResource(id) {
      this.request.delete("/resource/delete/" + id).then(data => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
            message: data.message
    ...
    addOrEditResource() {
      ...
      this.request.post("/resource/update", this.resourceForm)
          .then(data => {
            if (data.code === 200) {
              this.$notify.success({
                title: "成功",
