...
export default {
  ...
  methods: {
    ...
    listRoles() {
      ...
      this.request.get("/resource/role").then(data => {
        this.resourceList = data.data;
      });
      this.request.get("/menu/role").then(data => {
    ...
    deleteRoles(id) {
      ...
      this.request.delete("/role/delete", param).then(data => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
    ...
    saveOrUpdateRoleResource() {
      ...
      this.request.post("/role/update", this.roleForm).then(data => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
            message: data.message
    ...
    changeDisable(role) {
      this.request.post("/role/disable", role).then(data => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
            message: data.message
